    ...
    $(document).ready(function () {
      ...
      function animateCounter(counterElement) {
          counterElement.each(function () {
              var $this = $(this);
              $this.text(0); // Reset counter to 0 before counting up again
      ...
      function resetCounter(counterElement) {
          counterElement.each(function () {
              $(this).text('0'); // Reset the counter text when leaving the viewport
          });
      }
  
      $(window).scroll(function () {
          var counterElement = $('.counter-value');
          var oTop = counterElement.offset().top - window.innerHeight;
          var oBottom = counterElement.offset().top + counterElement.outerHeight();
  
          // Check if counter is within view and animate
          if ($(window).scrollTop() > oTop && $(window).scrollTop() < oBottom) {
              animateCounter(counterElement);
          } else {
              resetCounter(counterElement); // Reset the counter if it leaves the view
          }
      });
  
      // Trigger the scroll event to handle page reload scenario
      $(window).trigger('scroll');
    });
  
      /*==========================================================================
        // scroll count area end
    ==========================================================================*/
